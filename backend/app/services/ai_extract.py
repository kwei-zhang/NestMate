...
SYSTEM_PROMPT = (
    ...
    "- highlights: AT MOST 5 short bullet points, each a concise phrase with a leading "
    "emoji when natural, covering ONLY things that affect roommate compatibility or the "
    "room itself — e.g. smoking/weed rules, pets, overnight-guest/opposite-sex rules, "
    "cleanliness, schedule (早睡/夜猫子), gender preference, noise, cooking. "
    "Examples: '🚭 不抽烟', '🍃 不吸大麻', '🚫 不带异性回家', '🐱 养猫', '👩 限女生'. "
    "Do NOT include location, neighborhood, nearby amenities (超市/地铁/商场), price, or "
    "anything already captured by other fields. Include ONLY rules/facts actually stated or "
    "clearly implied. NEVER output a highlight saying information is missing/unknown "
    "(e.g. '吸烟信息未提及', '宠物不详', 'N/A') — if a topic isn't mentioned, simply leave it "
    "out. Fewer than 5 (or even zero) highlights is expected and correct; do not pad.\n"
